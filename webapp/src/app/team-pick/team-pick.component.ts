...
export class TeamPickComponent implements OnInit {
    ...
    chooseTeams() {
        const placeholderUrl = 'https://cdn.tutsplus.com/net/uploads/legacy/958_placeholders/placehold.gif';
        ...
        this.team1.badgeImage = (this.team1.badgeImage === '') ? placeholderUrl : this.team1.badgeImage;
        ...
        this.team2.badgeImage = (this.team2.badgeImage === '') ? placeholderUrl : this.team2.badgeImage;
