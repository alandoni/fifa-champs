...
export class InsertMatchComponent implements OnInit, OnChanges {
    ...
    validate() : boolean {
        ...
        if (this.checkRepeatedPlayer()) {
            this.error = { description: 'Verifique se há jogadores repetidos.' };
            return false;
        }
        if (this.checkScores(this.match.team1score, team.match.team2score)) {
        ...
        if (isTieAndFinal && checkScores(this.match.team1penalties, this.match.team2penalties)) {
